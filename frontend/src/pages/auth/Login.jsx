...
const Login = () => {
  ...
  const { login, loginWithGoogleProvider, updateUserFromBackend } = useAuth();
  ...
  /**
   * Handle email/password login - For backend email/password auth (not Firebase)
   */
  const handleEmailLogin = async (e) => {
    ...
    try {
      // Backend API call for email/password authentication
      ...
      updateUserFromBackend(user, token);
  ...
  /**
   * Handle Google Sign-In using popup flow
   */
